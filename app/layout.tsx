...
export const metadata = {
  title: 'Trevis Baker | Personal Portfolio',
  description: `Trevis is a full-stack developer with ${new Date().getFullYear() - 2008 - 1} years of experience. His core tech-stack React, Next.js, Node.js, and PostgresSQL.`,
};
